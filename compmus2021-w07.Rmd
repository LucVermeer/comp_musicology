You can download the raw source code for these lecture notes [here](./compmus2021-w07.Rmd).

## Agenda

### 11.00 · Chroma Features

- Lecture: What are chroma features? (20 mins)
- Demo: Sonic Visualiser (10 mins)
- Lecture: Dynamic time warping (15 mins)
- Break (5 mins)

### 11.50 · MIR vs. Music Cognition

- Lecture: MIR features and music cognition (15 mins)
- Questions: MIR and music cognition (5 mins)
- Breakout 1: Chroma and tuning (10 mins)
- Plenary Discussion: Breakout findings (10 mins)

### 12.30 · Lunch

- If you want some distraction, try converting your portfolio to a flexdashboard (if you haven't done so already).

### 13.00 · Chromagrams

- Review: flexdashboard (10 mins)
- Demo: Chromagrams (10 mins)
- Breakout: Chromagrams (15 mins)
- Plenary Discussion: Breakout findings (10 mins)
- Break (5 mins)

### 13.50 · Dynamic Time Warping
...
The breakout groups will be assigned at random. If you need help during any of the breakout sessions, please click the Help button, and the instructor or a TA will come to you.
...
In this breakout group, you will start working with chromagrams in R, and how to 
